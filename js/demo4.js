  ...
  class Slideshow {
    ...
    calculatePath(path = 'initial') {
      return path === 'initial'
        ...
        : `M 0,0 0,${this.rect.height} ${this.rect.width},${this.rect.height} ${
            this.rect.width
          },0 0,0 Z M ${this.frameSize},${this.frameSize} ${
            this.rect.width - this.frameSize
          },${this.frameSize / 2} ${this.rect.width - this.frameSize - 100},${
            this.rect.height - this.frameSize / 3
          } ${this.frameSize + 50},${this.rect.height - this.frameSize - 30} Z`;
    }
    initEvents() {
